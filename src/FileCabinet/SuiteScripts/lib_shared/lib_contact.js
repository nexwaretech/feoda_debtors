 ...
 * Author: Feoda
 */
define(['N/search', 'N/record', './lib_const.js', './lib_utils.js', './lib_entity.js'], function ( search,record, lib_const, lib_utils, lib_entity) {
    ...
    function getAttendingStudentContacts() {
        const contactSearchObj = search.create({
            ...
            filters: [
                ...
                'AND',
                [lib_entity.REC_ENTITY.STUDENT_STATUS, 'anyof', lib_const.LIST_STUDENT_STATUS.ATTENDING],
                'AND',
                ['isinactive', 'is', 'F']
            ],
            columns: [
        ...
        if (results && results.length > 0) {
            results.forEach(function (result, line) {
                ...
                students.push({
                    ...
                    familycode: result.getValue({name: "custentity_fam_cde", join: "company"}),
