 ...
 * Author: Feoda
 */
define(['N/search', 'N/record', './lib_const.js', './lib_billing_engine.js', './lib_billing_preference.js'], function (
  search,
  record,
  lib_const,
  lib_billing_engine,
  ...
  function getInstructionListFromItems(rec) {
    ...
    searchObj.run().each(function (result) {
      var objInstruction = {};
      if (
        arrCategories.findIndex(category => category.id == result.getValue(REC_BILLING_INSTRUCTION.BILLING_TYPE)) == -1
      ) {
        arrCategories.push({
