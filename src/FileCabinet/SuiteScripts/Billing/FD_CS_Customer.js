...
define([
  ...
  "N/ui/dialog",
  "./lib_billing",
], function (currentRecord, https, message, dialog, lib) {
  /**
  ...
  function redir_gen_inv() {
    ...
    let slURL = lib.generateInvoiceLink({ id: recordId });
    ...
    let objMsgPleaseWaitHolder = {};
    let objMsgSuccessHolder = {};
    let objMsgFailedHolder = {};
