          ...
          data: JSON.stringify({
            tempData: {
              startPeriod: bpRec.getValue(
                lib_billing_preference.REC_BILLING_PREFERENCE.MIDYEAR_START
              ),
              endPeriod: bpRec.getValue(
                lib_billing_preference.REC_BILLING_PREFERENCE.MIDYEAR_END
              ),
              freq: JSON.stringify(
                bpRec.getValue(
                  lib_billing_preference.REC_BILLING_PREFERENCE.MIDYEAR_FREQ
                )
              ),
              charges: JSON.stringify(
                bpRec.getValue(
                  lib_billing_preference.REC_BILLING_PREFERENCE.MIDYEAR_CHARGES
                )
              ),
              divValue: bpRec.getValue(
                lib_billing_preference.REC_BILLING_PREFERENCE.DIV_VAL
              ),
            },
