...
define([
  ...
  function renderForm(context) {
    ...
    var cc_dflt = debtor_dtl.findSublistLineWithValue({
    ...
    var amt_remaining = form.addField({
      id: 'amt',
